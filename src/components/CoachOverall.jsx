...
export default function CoachOverall({ matchStatsList, matchStatsMap, teamName, teamColor, teamId, allMatches, matchCount, top10Agg, top10PM, teamTier = 'free' }) {
  ...
  const rows = [
    ...
    { key: 'atkChances', label: "Atk chances", sub: "entries into attack zone",
      tVal: agg.team.atkChances || null, oVal: agg.opp.atkChances || null,
      t10Val: t10 ? (t10.team.atkChances || null) : null,
      suffix: "", trendKey: null,
      tAvgPM: avgPM(agg.team.atkChances, n), oAvgPM: avgPM(agg.opp.atkChances, n), t10AvgPM: t10 ? avgPM(t10.team.atkChances, t10n) : null,
    },
    { key: 'dEntry', label: "Attack \u2192 D", sub: "% of atk chances reaching D",
      tVal: pct(agg.team.dEntries, agg.team.atkChances || agg.team.dEntries),
      oVal: pct(agg.opp.dEntries, agg.opp.atkChances || agg.opp.dEntries),
      t10Val: t10 ? pct(t10.team.dEntries, t10.team.atkChances || t10.team.dEntries) : null,
